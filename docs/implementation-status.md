...
| Working branch | `claude/w02-a02a03-ratify` |
...
| Active package | W02 A02/A03 ratification (amendments owner-approved 2026-07-22); next the W02 `local_log` wire, encoder, privacy authorization, golden vectors, and sink interface toward G02 |
