...
| Working branch | `codex/dco-pr21-remediation` |
| Git state | Protected `main` commit `76511d5c63e4509765b3ad3ceabefba251e559c7` has the exact reviewed PR #21 tree, but its intended DCO trailer contains literal escaped newlines. Post-merge Required CI run `29902382356` correctly failed DCO and the aggregate; all other jobs passed. [Recovery evidence](gate-evidence/PR21-DCO.md) is in progress |
...
| Active package | W02 recovery: restore protected-main DCO enforcement after the PR #21 squash-message encoding incident, then resolve the persisted-log contract amendment |
