...
| Working branch | `claude/g02-acceptance` |
| Git state | Protected `main` at `92d99d1e9dc2551527c814c596f46e5507d61453` after the W02 `local_log` slices: A02/A03 ratification PR #26 (`54c240d`), egress surface PR #27 (`b66abf6`), CanonicalJSONV1 wire PR #28 (`b296682`), golden/determinism corpus PR #29 (`e89ca0c`), stream sink PR #30 (`bb0571d`), G02 evidence PR #31 (`b56b698`), the completed, hardened, and schema-locked wire — header/trailer/digest, hostile-failure normalization, and owner-approved amendment A05 (exact v1 stored schema) — PR #33 (`fad1479`), and the re-anchored G02 evidence packet applying plan amendment A04 / defect D02 (gate-scope correction superseding the withdrawn PR #32) PR #34 (`92d99d1`). Each merged with an exact-tree-verified DCO-signed protected commit and green post-merge Required CI. PR #35 (`90f8e4b`) corrected the acceptance evidence (A5 property-corpus surfaces, re-anchoring, the previously omitted PR #26/#27 failing-review dispositions) and landed the deferred G03/G06/G09/G16 `local_log` obligations. **The owner accepted G02 on 2026-07-24**, bound to `90f8e4b` with green post-merge Required CI (run 30064408885); W03 and W04 are unblocked. The original PR #21 squash remains noncompliant; its permanent exact historical disposition is recorded by owner-approved amendment A03 (2026-07-22, ADR 0017) |
...
| Active package | W03 — SQLite state, durable spool, replay, and retention (G02-gated), now unblocked. G02 was accepted by the owner on 2026-07-24, bound to protected `main` `90f8e4bcae02abe7f7fe42b3777db9d91580c248` with green post-merge Required CI ([run 30064408885](https://github.com/that1guy15/Milhouse-oss/actions/runs/30064408885)); see [G02.md](gate-evidence/G02.md). W04 (ClickHouse) is likewise unblocked |
...
| Locked decisions ratified by ADRs | Complete | `docs/adr/README.md` indexes 14 plan ratifications, accepted process ADR 0015, contract amendment ADR 0016, and disposition ADR 0017; local link and plan-anchor validation passed |
