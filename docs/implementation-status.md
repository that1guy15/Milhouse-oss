...
| Working branch | `claude/g02-evidence-packet` |
| Git state | Protected `main` at `fad147973f6ec3e65bfef7d7b01566d7dc75cdc4` after the W02 `local_log` slices: A02/A03 ratification PR #26 (`54c240d`), egress surface PR #27 (`b66abf6`), CanonicalJSONV1 wire PR #28 (`b296682`), golden/determinism corpus PR #29 (`e89ca0c`), stream sink PR #30 (`bb0571d`), G02 evidence PR #31 (`b56b698`), and the completed, hardened, and schema-locked wire — header/trailer/digest, hostile-failure normalization, and owner-approved amendment A05 (exact v1 stored schema) — PR #33 (`fad1479`). Each merged with an exact-tree-verified DCO-signed protected commit and green post-merge Required CI. This gate-scope correction (plan amendment A04 / defect D02, 2026-07-23) supersedes the withdrawn PR #32 and aligns the plan, ADR 0016, and the G02 evidence packet at `fad1479`; owner acceptance of G02 binds to this packet's protected merge commit. The original PR #21 squash remains noncompliant; its permanent exact historical disposition is recorded by owner-approved amendment A03 (2026-07-22, ADR 0017) |
...
| Active package | W02 `local_log` wire complete and schema-locked at `fad1479` (PR #33); G02 evidence re-anchored to `fad1479` in this packet with the corrected (plan amendment A04 / defect D02) W02-owned assertions ([G02.md](gate-evidence/G02.md)); owner acceptance of G02 is pending, after which W03 unblocks |
