...
| Working branch | `claude/w02-g02-correction` |
| Git state | Protected `main` at `b56b698ddf84dc5733c6694215c105b72423797b` after the W02 `local_log` slices: A02/A03 ratification PR #26 (`54c240d`), egress surface PR #27 (`b66abf6`), CanonicalJSONV1 wire PR #28 (`b296682`), golden/determinism corpus PR #29 (`e89ca0c`), stream sink PR #30 (`bb0571d`), and G02 evidence PR #31 (`b56b698`). Each merged with an exact-tree-verified DCO-signed protected commit and green post-merge Required CI. A follow-up owner-approved correction (plan amendment A04 / defect D02, 2026-07-23) in PR #32 re-scopes the G02 gate assertions across the plan, ADR 0016, and the evidence packet; its integrated candidate is the PR #32 head and owner acceptance of G02 binds to the PR #32 protected merge commit. The original PR #21 squash remains noncompliant; its permanent exact historical disposition is recorded by owner-approved amendment A03 (2026-07-22, ADR 0017) |
...
| Active package | W02 G02 gate-scope correction in PR #32 (plan amendment A04 / defect D02): plan, ADR 0016, and [G02.md](gate-evidence/G02.md) aligned; integrated candidate the PR #32 head, owner acceptance of G02 binds to the PR #32 merge, after which W03 unblocks |
