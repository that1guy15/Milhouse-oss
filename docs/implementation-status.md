...
| Working branch | `claude/w02-g02-evidence` |
| Git state | Protected `main` at `bb0571d291d52f7df1d2b4266fb2253bf669f91b` after the W02 `local_log` slices: A02/A03 ratification PR #26 (`54c240d`), egress surface PR #27 (`b66abf6`), CanonicalJSONV1 wire PR #28 (`b296682`), golden/determinism corpus PR #29 (`e89ca0c`), and stream sink PR #30 (`bb0571d`). Each merged with an exact-tree-verified DCO-signed protected commit and green post-merge Required CI. The original PR #21 squash remains noncompliant; its permanent exact historical disposition is recorded by owner-approved amendment A03 (2026-07-22, ADR 0017) |
...
| Active package | W02 G02 evidence assembled at `bb0571d` ([G02.md](gate-evidence/G02.md)); owner acceptance of G02 is pending, after which W03 unblocks |
