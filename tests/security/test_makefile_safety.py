...
CRITICAL_COVERAGE_FILES = {
    ...
    "src/milhouse/core/errors.py",
    "src/milhouse/core/logging.py",
    "src/milhouse/core/log_wire.py",
    "src/milhouse/domain/_validation.py",
    ...
    "src/milhouse/state/alert_state.py",
    ...
    "src/milhouse/storage/_identifiers.py",
    "src/milhouse/storage/client.py",
    "src/milhouse/storage/errors.py",
    "src/milhouse/storage/exporter.py",
    "src/milhouse/storage/repository.py",
    "src/milhouse/storage/runner.py",
    "src/milhouse/storage/schema.py",
    "src/milhouse/runtime/__init__.py",
    "src/milhouse/runtime/alerting.py",
    "src/milhouse/runtime/context.py",
    "src/milhouse/runtime/errors.py",
    "src/milhouse/runtime/pipeline.py",
    "src/milhouse/runtime/registry.py",
    "src/milhouse/runtime/result.py",
    "src/milhouse/http/client.py",
    "src/milhouse/http/errors.py",
    "src/milhouse/collectors/site_canary.py",
